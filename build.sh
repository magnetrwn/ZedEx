...
#   if [ "$RUN_PERF_STAT" = "ON" ]
#   then
#     perf stat --repeat=5 --table --detailed bin/ZedEx tests/res/diag2.com 0x100
#   fi

#   if [ "$RUN_PERF_RECORD" = "ON" ]
#   then
#     perf record -F 8000 -g -- bin/ZedEx tests/res/diag2.com 0x100
#     perf report
#     rm perf.data
#   fi
# fi
...
#   if [ "$RUN_MEMCHECK" = "ON" ]
#   then
#     #valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes bin/ZedEx tests/res/diag2.com
#     valgrind --tool=memcheck bin/ZedEx "tests/res/cpudiag.bin"
#   fi
# fi
